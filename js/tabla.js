...
/*JVELASQUEZ - 17/09/2013: Se corrigio la situación en la que se desea formato decimal pero el valor recibido es un entero.
También se cambiaron los campos bool y checkbox para que null sea false.*/

/*JVELASQUEZ - 23/09/2013: Si la tabla se vuelve a cargar y el filtro de la misma no está vacío, se filtra la tabla
por el contenido del mismo.*/

/*JVELASQUEZ - 03/10/2013: Si existe un error al mostrar la fecha, se muestra "". El autonumérico ya no se reinicia en cada
página de la tabla.*/

/*MBARILLAS - 08/10/2013: Se valida que al ordenar los datos no se comparen null*/
            ...
            else
            {
                ...
                switch (Tipo)
                {
                    ...
                    case "bool":
                        ...
                        //JVELASQUEZ - 17/09/2013: null tambien es false.
                        var icono = $(document.createElement('i'));

                        if (fila[Campo] == false || fila[Campo] == 0 || fila[Campo] == null)
                        {
                            icono.addClass("icon-remove-sign");
                        }
                        else
                        {
                            icono.addClass("icon-ok-sign");
                        }
...
$("div.form-search > input.search-query").keyup(function (event)
{
    ...
    var asc = $("#" + tabla + " > thead > tr > th > i.icon-chevron-up").parent();
    var desc = $("#" + tabla + " > thead > tr > th > i.icon-chevron-down").parent();
    var Columna = null;
    var tipo = null;
    var orden;
